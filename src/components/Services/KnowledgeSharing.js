          ...
          <div className="row align-items-center g-4">
            ...
            <div className="col-lg-6 col-12 text-center text-lg-start">
              ...
              <p className="knowledge-description">
                We offer tailored knowledge-sharing solutions that foster collaboration and streamline resources. 
                Our platforms enable teams to innovate and make decisions. By tapping collective expertise,
                 we help businesses drive productivity and growth, empowering organizations to turn knowledge into action.
              </p>
            </div>
          </div>
